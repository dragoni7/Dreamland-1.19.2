...
public class ConfiguredDreamlandFeatures {
	...
	public static final ConfiguredFeature<NoneFeatureConfiguration, ?> HIVE_PILLAR = FeatureUtils.register("hive_pillar", DreamlandFeatures.HIVE_SPIKE.configured(FeatureConfiguration.NONE));
