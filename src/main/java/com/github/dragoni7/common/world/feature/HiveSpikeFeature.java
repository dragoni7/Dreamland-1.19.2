...
public class HiveSpikeFeature extends Feature<NoneFeatureConfiguration>{
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> p_159882_) {
	      ...
	      if (!worldgenlevel.getBlockState(blockpos).is(DreamlandBlocks.HIVE_BLOCK.get())) {
	         return false;
	      } else {
	         ...
	         for(int l1 = -k1; l1 <= k1; ++l1) {
	            for(int i2 = -k1; i2 <= k1; ++i2) {
	               ...
	               while(blockpos1.getY() > 0) {
	                  ...
	                  this.setBlock(worldgenlevel, blockpos1, DreamlandBlocks.HIVE_BLOCK.get().defaultBlockState());
