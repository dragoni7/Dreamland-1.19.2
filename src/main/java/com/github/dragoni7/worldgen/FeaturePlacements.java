...
public class FeaturePlacements {
	...
	public static final PlacedFeature PlACED_WHITE_MOLD = PlacementUtils.register("placed_white_mold", DreamlandFeatures.MOLD_PATCH.placed(CountPlacement.of(UniformInt.of(10, 47)), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.top()), EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.solid(), BlockPredicate.ONLY_IN_AIR_PREDICATE, 12), RandomOffsetPlacement.vertical(ConstantInt.of(1)), BiomeFilter.biome()));
