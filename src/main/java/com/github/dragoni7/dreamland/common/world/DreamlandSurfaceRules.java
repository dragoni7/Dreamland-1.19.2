...
public class DreamlandSurfaceRules
{
    ...
    private static final SurfaceRules.RuleSource WHITE_MOLD_PATCHES = SurfaceRules.ifTrue(SurfaceRules.abovePreliminarySurface(), SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.CALCITE, -0.9, 0.1), SurfaceRules.state(DreamlandBlocks.WHITE_MOLD.block().get().defaultBlockState())));
