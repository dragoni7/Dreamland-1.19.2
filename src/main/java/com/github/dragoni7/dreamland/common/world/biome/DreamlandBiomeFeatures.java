...
public class DreamlandBiomeFeatures {
	...
	public static void toxicJungleBiomeFeatures(BiomeGenerationSettings.Builder builder) {
		...
		builder.addFeature(GenerationStep.Decoration.RAW_GENERATION, DreamlandFeaturePlacements.POROUS_STONE_UNDERGROUND);
		builder.addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, DreamlandFeaturePlacements.NECRATHENE_ORE);
		builder.addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, DreamlandFeaturePlacements.PURITY_ORE);
		...
		builder.addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, DreamlandFeaturePlacements.TOXIC_JUNGLE_DELTA);
		builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, DreamlandFeaturePlacements.PURIFIED_DUST_LAYER);
		...
		builder.addFeature(GenerationStep.Decoration.TOP_LAYER_MODIFICATION, DreamlandFeaturePlacements.MOLD_CARPET_DIRT);
		builder.addFeature(GenerationStep.Decoration.TOP_LAYER_MODIFICATION, DreamlandFeaturePlacements.MOLD_CARPET_STONE);
		...
		builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, DreamlandFeaturePlacements.GLOWING_MOLD_WOOD);
		builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, DreamlandFeaturePlacements.SPORE_NODE);
	}
}
