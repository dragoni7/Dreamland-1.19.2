...
public class BreatherHelmetArmorItem extends GeoArmorItem implements IAnimatable {
	
	private AnimationFactory factory = new AnimationFactory(this);

	public BreatherHelmetArmorItem(ArmorMaterial materialIn, EquipmentSlot slot, Properties builder) {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController(this, "BreatherHelmetArmorItemController", 20, this::predicate));
	}
