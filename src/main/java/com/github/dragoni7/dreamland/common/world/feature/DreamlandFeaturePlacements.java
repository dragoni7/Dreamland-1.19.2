...
public class DreamlandFeaturePlacements {
	...
	public static final Holder<PlacedFeature> MOLD_CARPET = registerPlacedFeature("mold_carpet", DreamlandConfiguredFeatures.MOLD_CARPET, CountPlacement.of(100), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(-10), VerticalAnchor.top()), EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.matchesBlocks(List.of(DreamlandWoodSets.MOLD_WOOD.log().block().get(), DreamlandWoodSets.MOLD_WOOD.wood().block().get(), DreamlandBlocks.TOXIC_DIRT.block().get(), DreamlandBlocks.TOXIC_GRASS.block().get(), DreamlandBlocks.BLACK_MOLD.block().get(), DreamlandBlocks.WHITE_MOLD.block().get(), DreamlandBlocks.POROUS_STONE.block().get(), DreamlandBlocks.OVERGROWN_POROUS_STONE.block().get(), DreamlandBlocks.PETRIFIED_VEGETATION.block().get())), BlockPredicate.ONLY_IN_AIR_PREDICATE, 12), RandomOffsetPlacement.vertical(ConstantInt.of(1)), BiomeFilter.biome());
	...
	public static final Holder<PlacedFeature> MOLD_WOOD_TREE = registerPlacedFeature("mold_wood_tree", DreamlandConfiguredFeatures.MOLD_WOOD_TREE, RarityFilter.onAverageOnceEvery(5), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
	...
	public static final Holder<PlacedFeature> TOXIC_VEGETATION = registerPlacedFeature("toxic_vegetation", DreamlandConfiguredFeatures.TOXIC_VEGETATION, commonOrePlacement(16, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.top())));
	public static final Holder<PlacedFeature> DECAYED_VEGETATION = registerPlacedFeature("decayed_vegetation", DreamlandConfiguredFeatures.DECAYED_VEGETATION, commonOrePlacement(8, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.top())));
