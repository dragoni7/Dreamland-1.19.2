...
public class DreamlandFeaturePlacements {
	...
	public static final Holder<PlacedFeature> TOXIC_JUNGLE_DELTA = registerPlacedFeature("toxic_jungle_delta", DreamlandConfiguredFeatures.TOXIC_JUNGLE_DELTA, CountPlacement.of(UniformInt.of(36, 96)), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(0)), BiomeFilter.biome());
	public static final Holder<PlacedFeature> PURIFIED_DUST_LAYER = registerPlacedFeature("purified_dust_layer", DreamlandConfiguredFeatures.PURIFIED_DUST_LAYER, CountPlacement.of(UniformInt.of(0, 64)), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(0)), BiomeFilter.biome());
