...
public class DreamlandConfiguredFeatures {
	...
	public static final RuleTest GLOWING_MOLD_WOOD_REPLACEABLE = new BlockMatchTest(DreamlandWoodSets.MOLD_WOOD.wood().block().get());
	...
	public static final RuleTest PETRIFIED_VEGETATION = new BlockMatchTest(DreamlandBlocks.PETRIFIED_VEGETATION.block().get());
	...
	public static final Holder<ConfiguredFeature<GrowthLayerConfig, ?>> HIVE_GROWTH = registerConfiguredFeature("hive_growth", DreamlandFeatures.GROWTH_LAYER, new GrowthLayerConfig(BlockStateProvider.simple(DreamlandBlocks.HIVE_GROWTH.block().get().defaultBlockState()), BlockStateProvider.simple(DreamlandBlocks.HIVE_BLOCK.block().get().defaultBlockState()), ConstantInt.of(4), ConstantInt.of(2)));
	...
	public static final Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> TOXIC_JUNGLE_VEGETATION = registerConfiguredFeature("toxic_jungle_vegetation", Feature.RANDOM_PATCH, new RandomPatchConfiguration(48, 5, 3, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(DreamlandBlocks.SPONGE_PUFF.block().get().defaultBlockState(), 25).add(DreamlandBlocks.SPORE_PUFF.block().get().defaultBlockState(), 15).add(Blocks.BROWN_MUSHROOM.defaultBlockState(), 10).add(Blocks.TALL_GRASS.defaultBlockState(), 15).add(DreamlandBlocks.GLOW_FRONDS.block().get().defaultBlockState(), 15).add(DreamlandBlocks.LARGE_SPORE_PUFF.block().get().defaultBlockState(), 20))))));
	public static final Holder<ConfiguredFeature<GrowthLayerConfig, ?>> MOLD_CARPET_STONE = registerConfiguredFeature("mold_carpet_stone", DreamlandFeatures.GROWTH_LAYER, new GrowthLayerConfig(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(DreamlandBlocks.BLACK_MOLD_CARPET.block().get().defaultBlockState(), 25).add(DreamlandBlocks.WHITE_MOLD_CARPET.block().get().defaultBlockState(), 75)), BlockStateProvider.simple(DreamlandBlocks.POROUS_STONE.block().get()), ConstantInt.of(6), ConstantInt.of(3)));
	public static final Holder<ConfiguredFeature<GrowthLayerConfig, ?>> MOLD_CARPET_DIRT = registerConfiguredFeature("mold_carpet_dirt", DreamlandFeatures.GROWTH_LAYER, new GrowthLayerConfig(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(DreamlandBlocks.BLACK_MOLD_CARPET.block().get().defaultBlockState(), 25).add(DreamlandBlocks.WHITE_MOLD_CARPET.block().get().defaultBlockState(), 75)), BlockStateProvider.simple(DreamlandBlocks.TOXIC_GRASS.block().get()), ConstantInt.of(6), ConstantInt.of(2)));
	public static final Holder<ConfiguredFeature<GrowthLayerConfig, ?>> MOLD_CARPET_UNDERGROUND = registerConfiguredFeature("mold_carpet_underground", DreamlandFeatures.GROWTH_LAYER, new GrowthLayerConfig(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(DreamlandBlocks.BLACK_MOLD_CARPET.block().get().defaultBlockState(), 25).add(DreamlandBlocks.WHITE_MOLD_CARPET.block().get().defaultBlockState(), 75)), BlockStateProvider.simple(DreamlandBlocks.PETRIFIED_VEGETATION.block().get()), ConstantInt.of(8), ConstantInt.of(2)));
	...
	public static final Holder<ConfiguredFeature<MultifaceGrowthConfiguration, ?>> SPORE_NODE = registerConfiguredFeature("spore_node", Feature.MULTIFACE_GROWTH, new MultifaceGrowthConfiguration(SPORE_NODE_BLOCK, 24, true, true, true, 0.9F, HolderSet.direct(Block::builtInRegistryHolder, DreamlandWoodSets.MOLD_WOOD.log().block().get(), DreamlandWoodSets.MOLD_WOOD.wood().block().get(), DreamlandBlocks.POROUS_STONE.block().get(), DreamlandBlocks.OVERGROWN_POROUS_STONE.block().get(), DreamlandBlocks.PETRIFIED_VEGETATION.block().get(), DreamlandBlocks.TOXIC_DIRT.block().get(), DreamlandBlocks.WHITE_MOLD.block().get(), DreamlandBlocks.BLACK_MOLD.block().get())));
	public static final Holder<ConfiguredFeature<OreConfiguration, ?>> TOXIC_VEGETATION = registerConfiguredFeature("toxic_vegetation", Feature.ORE, new OreConfiguration(TOXIC_JUNGLE_GROUND, DreamlandBlocks.TOXIC_VEGETATION.block().get().defaultBlockState(), 24));
	public static final Holder<ConfiguredFeature<OreConfiguration, ?>> DECAYED_VEGETATION = registerConfiguredFeature("decayed_vegetation", Feature.ORE, new OreConfiguration(TOXIC_JUNGLE_GROUND, DreamlandBlocks.DECAYED_VEGETATION.block().get().defaultBlockState(), 16));
	public static final Holder<ConfiguredFeature<OreConfiguration, ?>> GLOWING_MOLD_WOOD = registerConfiguredFeature("glowing_mold_wood", Feature.ORE, new OreConfiguration(GLOWING_MOLD_WOOD_REPLACEABLE, DreamlandBlocks.GLOWING_MOLD_WOOD.block().get().defaultBlockState(), 24));
	public static final Holder<ConfiguredFeature<DeltaFeatureConfiguration, ?>> TOXIC_JUNGLE_DELTA = registerConfiguredFeature("toxic_jungle_delta", Feature.DELTA_FEATURE, new DeltaFeatureConfiguration(Blocks.WATER.defaultBlockState(), DreamlandBlocks.PURE_STONE.block().get().defaultBlockState(), UniformInt.of(3, 7), UniformInt.of(1, 2)));
	public static final Holder<ConfiguredFeature<GrowthLayerConfig, ?>> PURIFIED_DUST_LAYER = registerConfiguredFeature("purified_dust_layer", DreamlandFeatures.GROWTH_LAYER, new GrowthLayerConfig(BlockStateProvider.simple(DreamlandBlocks.PURIFIED_DUST.block().get().defaultBlockState()), BlockStateProvider.simple(DreamlandBlocks.PURE_STONE.block().get()), ConstantInt.of(4), ConstantInt.of(3)));
	public static final Holder<ConfiguredFeature<OreConfiguration, ?>> NECRATHENE_ORE = registerConfiguredFeature("necrathene_ore", Feature.ORE, new OreConfiguration(NECRATHENE_REPLACEABLE, DreamlandBlocks.NECRATHENE_ORE.block().get().defaultBlockState(), 6));
