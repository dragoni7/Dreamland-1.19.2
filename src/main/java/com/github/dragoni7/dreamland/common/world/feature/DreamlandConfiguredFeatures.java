...
public class DreamlandConfiguredFeatures {
	...
	public static final Holder<ConfiguredFeature<MultifaceGrowthConfiguration, ?>> SPORE_NODE = registerConfiguredFeature("shelf_vegetation", Feature.MULTIFACE_GROWTH, new MultifaceGrowthConfiguration(SPORE_NODE_BLOCK, 24, true, true, true, 0.9F, HolderSet.direct(Block::builtInRegistryHolder, DreamlandWoodSets.MOLD_WOOD.log().block().get(), DreamlandWoodSets.MOLD_WOOD.wood().block().get(), DreamlandBlocks.POROUS_STONE.block().get(), DreamlandBlocks.OVERGROWN_POROUS_STONE.block().get(), DreamlandBlocks.PETRIFIED_VEGETATION.block().get(), DreamlandBlocks.TOXIC_DIRT.block().get(), DreamlandBlocks.WHITE_MOLD.block().get(), DreamlandBlocks.BLACK_MOLD.block().get())));
