...
public class DreamlandTiles {
	...
	public static final RegistryObject<BlockEntityType<AncientEggTile>> ANCIENT_EGG = TILES
			.register("ancient_egg_tile", () -> BlockEntityType.Builder
					.of(AncientEggTile::new, DreamlandBlocks.ANCIENT_EGG.block().get()).build(null));
}
